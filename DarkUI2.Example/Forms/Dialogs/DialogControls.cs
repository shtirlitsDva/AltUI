...
namespace DarkUI2.Example
{
    public partial class DialogControls : DarkDialog
    {
        public DialogControls()
        {
            ...
            {
                DarkMessageBox.ShowError("This is an error", "Dark UI - DarkUI2.Example");
            };

            btnMessageBox.Click += delegate
            {
                DarkMessageBox.ShowInformation("This is some information, except it is much bigger, so there we go. I wonder how this is going to go. I hope it resizes properly. It probably will.", "Dark UI - DarkUI2.Example");
            };
        }
    }
}
